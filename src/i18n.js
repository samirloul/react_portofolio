  ...
  en: {
    ...
    about: {
      ...
      timeline: [
        ...
        {
          years: "2019 - 2021",
          title: "VMBO (General Years) - Globe College Utrecht",
          text: "I studied at Globe College Utrecht in the first two VMBO years, where I followed general education subjects without a specific direction yet.",
        },
        {
          years: "2021 - 2023",
          title: "VMBO Mobility & Transport - Globe College Utrecht",
          text: "In the next two VMBO years at Globe College Utrecht, I studied Mobility & Transport and gained practical knowledge about modern transport systems and solutions.",
        },
        {
          years: "2023 - 2024",
    ...
    cv: {
      ...
      education: [
        ...
        {
          years: "2019 - 2021",
          title: "VMBO (General Years)",
          place: "Globe College Utrecht",
          text: "Completed the first two VMBO years with general education subjects before choosing a specific direction.",
        },
        {
          years: "2017 - 2019",
    ...
    newsletter: {
      title: "Stay Updated",
      subtitle: "Get notified about new projects and articles",
    ...
    feedback: {
      ...
      subtitle: "Help me improve this portfolio",
    ...
    blog: {
      ...
      subtitle: "Thoughts, tutorials, and experiences",
      postedOn: "Posted on",
      readMore: "Read More",
      posts: [
        {
    ...
    testimonials: {
      ...
      subtitle: "Feedback from friends and mentors",
      sampleMessage1: "Samir is a talented developer with great problem-solving skills.",
      sampleAuthor1: "Friend",
      sampleMessage2: "His passion for learning is inspiring and his code quality is excellent.",
      sampleAuthor2: "Mentor",
      sampleMessage3: "Working with Samir has been a great pleasure. Highly recommended!",
      sampleAuthor3: "Colleague",
    },
    rating: {
    ...
    share: {
      shareText: "Check out this amazing project",
  ...
  ar: {
    ...
    about: {
      ...
      timeline: [
        ...
        { years: "2019 - 2021", title: "VMBO (السنوات العامة) - Globe College Utrecht", text: "درست في Globe College Utrecht خلال أول سنتين من VMBO، حيث تابعت مواد تعليمية عامة بدون تخصص محدد بعد." },
        { years: "2021 - 2023", title: "VMBO النقل والمواصلات - Globe College Utrecht", text: "في السنتين التاليتين من VMBO في Globe College Utrecht، درست النقل والمواصلات واكتسبت معرفة عملية حول أنظمة وحلول النقل الحديثة." },
    ...
    cv: {
      ...
      education: [
        ...
        { years: "2019 - 2021", title: "VMBO (السنوات العامة)", place: "Globe College Utrecht", text: "أكملت أول سنتين من VMBO بمواد تعليمية عامة قبل اختيار مسار تخصصي." },
    ...
    newsletter: {
      title: "ابقَ محدثاً",
      subtitle: "احصل على إشعارات حول المشاريع الجديدة",
    ...
    feedback: {
      title: "تقييم سريع",
      subtitle: "ساعدني في تحسين هذه المحفظة",
      rating: "قيّم هذه المحفظة",
      excellent: "ممتاز",
      good: "جيد",
      average: "متوسط",
      poor: "ضعيف",
      placeholder: "قل لي رأيك...",
    ...
    visitorStats: {
      title: "نشاط الزوار",
      visitorsToday: "اليوم",
      visitorsTotal: "الإجمالي",
    },
    blog: {
      title: "آخر المقالات",
      subtitle: "الأفكار والبرامج التعليمية والخبرات",
      postedOn: "نُشر في",
      readMore: "اقرأ المزيد",
      posts: [
        {
          title: "بناء أول معرض أعمال لي باستخدام React",
          excerpt: "رحلة في React Hooks، والتنسيق، والنشر...",
        },
        {
          title: "تعلّم تطوير الويب في 2025",
          excerpt: "أفكاري حول أطر JavaScript وأفضل الممارسات...",
        },
        {
          title: "من سوريا إلى هولندا: رحلة تقنية",
          excerpt: "كيف انتقلت إلى مجال التقنية أثناء التأقلم في بلد جديد...",
        },
      ],
    },
    testimonials: {
      title: "ماذا يقول الناس",
      subtitle: "آراء من الأصدقاء والمرشدين",
      sampleMessage1: "سمير مطور موهوب بمهارات قوية في حل المشاكل.",
      sampleAuthor1: "صديق",
      sampleMessage2: "شغفه بالتعلم مثير للإلهام وجودة الكود متميزة.",
      sampleAuthor2: "مرشد",
      sampleMessage3: "كان العمل مع سمير متعة كبيرة. موصى به بشدة!",
      sampleAuthor3: "زميل",
    },
    rating: {
      title: "قيم هذا المشروع",
      thanksForRating: "شكراً لتقييمك!",
    },
    share: {
      shareText: "تحقق من هذا المشروع الرائع",
      shareTitle: "شارك هذا المشروع",
  ...
  nl: {
    ...
    about: {
      ...
      timeline: [
        ...
        { years: "2019 - 2021", title: "VMBO (Algemene Jaren) - Globe College Utrecht", text: "Ik volgde op Globe College Utrecht de eerste twee VMBO-jaren met algemene vakken, nog zonder specifieke richting." },
        { years: "2021 - 2023", title: "VMBO Mobiliteit & Transport - Globe College Utrecht", text: "In de volgende twee VMBO-jaren op Globe College Utrecht studeerde ik Mobiliteit & Transport en deed ik praktische kennis op over moderne transportsystemen en oplossingen." },
    ...
    cv: {
      ...
      education: [
        ...
        { years: "2019 - 2021", title: "VMBO (Algemene Jaren)", place: "Globe College Utrecht", text: "De eerste twee VMBO-jaren afgerond met algemene vakken, voordat ik een specifieke richting koos." },
    ...
    // Feature Translations - Dutch
    newsletter: {
      title: "Blijf Op de Hoogte",
      subtitle: "Ontvang meldingen over nieuwe projecten en artikelen",
      placeholder: "jouw@email.com",
      subscribe: "Abonneren",
      success: "Dank je wel voor je abonnement!",
      error: "Voer alstublieft een geldig e-mailadres in",
    },
    feedback: {
      title: "Snel Feedback",
      subtitle: "Help mij deze portfolio te verbeteren",
      rating: "Beoordeel deze portfolio",
      excellent: "Uitstekend",
      good: "Goed",
      average: "Gemiddeld",
      poor: "Slecht",
      placeholder: "Vertel me wat je denkt...",
      submit: "Feedback Verzenden",
      thanks: "Dank je wel voor je feedback!",
    },
    visitorStats: {
      title: "Bezoekersactiviteit",
      visitorsToday: "Vandaag",
      visitorsTotal: "Totaal",
    },
    blog: {
      title: "Nieuwste Artikelen",
      subtitle: "Gedachten, tutorials en ervaringen",
      postedOn: "Geplaatst op",
      readMore: "Meer Lezen",
      posts: [
        {
          title: "Mijn eerste React-portfolio bouwen",
          excerpt: "Een reis door React hooks, styling en deployment...",
        },
        {
          title: "Webontwikkeling leren in 2025",
          excerpt: "Mijn gedachten over JavaScript-frameworks en best practices...",
        },
        {
          title: "Van Syrië naar Nederland: een techreis",
          excerpt: "Hoe ik naar tech ben overgestapt terwijl ik me aanpaste aan een nieuw land...",
        },
      ],
    },
    testimonials: {
      title: "Wat Anderen Zeggen",
      subtitle: "Feedback van vrienden en mentoren",
      sampleMessage1: "Samir is een getalenteerde ontwikkelaar met sterke probleemoplossingsvaardigheden.",
      sampleAuthor1: "Vriend",
      sampleMessage2: "Zijn passie voor leren is inspirerend en de code kwaliteit is uitstekend.",
      sampleAuthor2: "Mentor",
      sampleMessage3: "Het was een genoegen om met Samir te werken. Sterk aanbevolen!",
      sampleAuthor3: "Collega",
    },
    rating: {
      title: "Beoordeel dit Project",
      thanksForRating: "Dank je wel voor je beoordeling!",
    },
    share: {
      shareText: "Bekijk dit geweldige project",
      shareTitle: "Deel dit project",
