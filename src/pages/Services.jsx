...
export default function Services({ t }) {
  ...
  return (
    <main className="container content-page" style={{ paddingTop: "2rem", paddingBottom: "4rem" }}>
      <PageVisual image="/fotos/samir-loul-web-development-services.png" alt="Samir Loul web development services including Laravel, PHP, React and full stack development" eyebrow={t?.nav?.services || "Services"} title={t?.services?.title || "Services"} text={t?.services?.intro} />
